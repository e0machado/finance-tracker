...
import com.ems.financetracker.dto.CreditCardStatementDTO;
import com.ems.financetracker.service.CreditCardStatementService;
...
/**
 * REST controller responsible for handling {@link com.ems.financetracker.model.entity.CreditCardStatement}
...
public class CreditCardStatementController {
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the statement does not exist
     */
    @GetMapping("/{id}")
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the associated credit card is not found
     */
    @PostMapping
