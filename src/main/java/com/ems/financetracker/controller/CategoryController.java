...
import com.ems.financetracker.dto.CategoryDTO;
import com.ems.financetracker.service.CategoryService;
...
/**
 * REST controller responsible for handling {@link com.ems.financetracker.model.entity.Category}
...
public class CategoryController {
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the category does not exist
     */
    @GetMapping("/{id}")
     ...
     * @throws com.ems.financetracker.exception.BusinessException if the category name is already in use
     */
    @PostMapping
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the category does not exist
     * @throws com.ems.financetracker.exception.BusinessException if the category name is already in use by another category
     */
    @PatchMapping("/{id}")
