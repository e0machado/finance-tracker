...
import com.ems.financetracker.dto.CreditCardDTO;
import com.ems.financetracker.service.CreditCardService;
...
/**
 * REST controller responsible for handling {@link com.ems.financetracker.model.entity.CreditCard}
...
public class CreditCardController {
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the credit card does not exist
     */
    @GetMapping("/{id}")
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the associated user is not found
     */
    @PostMapping
