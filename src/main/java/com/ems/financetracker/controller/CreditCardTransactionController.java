...
import com.ems.financetracker.service.CreditCardTransactionService;
...
/**
 * REST controller responsible for handling {@link com.ems.financetracker.model.entity.CreditCardTransaction}
...
public class CreditCardTransactionController {
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the transaction does not exist
     */
    @GetMapping("/{id}")
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the credit card, category or statement is not found
     */
    @PostMapping
