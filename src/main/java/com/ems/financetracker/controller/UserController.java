...
import com.ems.financetracker.dto.UserDTO;
import com.ems.financetracker.service.UserService;
...
/**
 * REST controller responsible for handling {@link com.ems.financetracker.model.entity.User}
...
public class UserController {
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the user does not exist
     */
    @GetMapping("/{id}")
     ...
     * @throws com.ems.financetracker.exception.BusinessException if the email is already in use
     */
    @PostMapping
     ...
     * @throws com.ems.financetracker.exception.ResourceNotFoundException if the user does not exist
     * @throws com.ems.financetracker.exception.BusinessException if the email is already in use by another user
     */
    @PatchMapping("/{id}")
