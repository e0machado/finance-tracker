...
import com.ems.financetracker.model.enums.CreditCardTransactionType;
...
/**
 * Interface encapsulating {@link com.ems.financetracker.model.entity.CreditCardTransaction}-related
...
public interface CreditCardTransactionDTO {
    ...
    /**
     * Reference DTO representing a {@link com.ems.financetracker.model.entity.CreditCard} by its identifier.
     */
    record CreditCardRef(@NotNull Long id) {}

    /**
     * Reference DTO representing a {@link com.ems.financetracker.model.entity.Category} by its identifier.
     */
    record CategoryRef(@NotNull Long id) {}

    /**
     * Reference DTO representing a {@link com.ems.financetracker.model.entity.CreditCardStatement} by its identifier.
     */
